...
public class NovelException extends Exception {
	...
	public NovelException(HttpStatus status) {
		this();
		this.status = status;
	}

	public NovelException(HttpStatus status, Throwable ex) {
		this();
		this.status = status;
	...
	public NovelException(HttpStatus status, String message, Throwable ex) {
		this();
		this.status = status;
